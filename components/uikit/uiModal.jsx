...
export default function UiModal({ showModal, userActive, userData }) {
    ...
    function handleFormSubmit(event) {
        ...
        if (activeLink == 'Регистрация'){
            axios.post('https://digital-up-back-1.onrender.com/users', { login, password })
            .then(response => {
        ...
        if (activeLink == 'Вход'){
            axios.post('https://digital-up-back-1.onrender.com/users/sign_in', { login, password })
            .then(response => {
...
function UserInfo({ userData }){
    ...
    function handleSubmitNewName(event){
        ...
        axios.patch('https://digital-up-back-1.onrender.com/users/name', {id, name})
            .then(response => {
